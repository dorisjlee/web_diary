var Zepto = function() {
    function t(t) {
        return null == t ? String(t) : U[B.call(t)] || "object"
    }
    ...
    return X.matches = function(t, e) {
        ...
        var r, i, a;
        return Z.test(t) && (r = j(P.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(_, "<$1></$2>")), e === w && (e = L.test(t) && RegExp.$1), e in I || (e = "*"), a = I[e], a.innerHTML = "" + t, r = j.each(N.call(a.childNodes), function() {
            a.removeChild(this)
        ...
        if (!t) return X.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && L.test(t)) r = X.fragment(t, RegExp.$1, n), t = null;
            else {
            ...
            else if (L.test(t)) r = X.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== w) return j(n).find(t);
                r = X.qsa(P, t)
            }
    ...
    }), X.Z.prototype = j.fn, X.uniq = T, X.deserializeValue = b, j.zepto = X, j
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function(t, e, n) {
        t("a#slide").click(function() {
            ...
            if (console.log(e.code), !t(".search-form").hasClass("active")) switch (e.code) {
                case "Space":
                    t("a#slide").trigger("click"), t("");
                    break;
                case "Escape":
                    t("#fade").trigger("click")
            }
            if (t("#sidebar").hasClass("slide")) switch (e.code) {
                case "Digit1":
                    t("#sidebar ul li:first-child a").trigger("click");
                    break;
                case "Digit2":
                    t("#sidebar ul li:nth-child(2) a").trigger("click");
                    break;
                case "Digit3":
                    t("#sidebar ul li:nth-child(3) a").trigger("click");
                    break;
                case "Digit4":
                    t("#sidebar ul li:nth-child(4) a").trigger("click");
                    break;
                case "Digit5":
                    t("#sidebar ul li:nth-child(5) a").trigger("click");
                    break;
                case "KeyP":
